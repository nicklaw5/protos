...
var file_cauldron_v1alpha_player_service_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x52, 0x06, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x32, 0x82, 0x01, 0x0a, 0x0d, 0x50,
...
var file_cauldron_v1alpha_player_service_proto_goTypes = []interface{}{
	...
	nil,                           // 2: nicklaw5.cauldron.v1alpha.CreatePlayerRequest.DataEntry
...
var file_cauldron_v1alpha_player_service_proto_depIdxs = []int32{
	2, // 0: nicklaw5.cauldron.v1alpha.CreatePlayerRequest.data:type_name -> nicklaw5.cauldron.v1alpha.CreatePlayerRequest.DataEntry
	3, // 1: nicklaw5.cauldron.v1alpha.CreatePlayerRequest.created_at:type_name -> google.protobuf.Timestamp
	3, // 2: nicklaw5.cauldron.v1alpha.CreatePlayerRequest.updated_at:type_name -> google.protobuf.Timestamp
	4, // 3: nicklaw5.cauldron.v1alpha.CreatePlayerResponse.status:type_name -> nicklaw5.common.types.v1alpha.Status
	5, // 4: nicklaw5.cauldron.v1alpha.CreatePlayerResponse.player:type_name -> nicklaw5.cauldron.v1alpha.Player
	6, // 5: nicklaw5.cauldron.v1alpha.CreatePlayerRequest.DataEntry.value:type_name -> google.protobuf.Struct
	0, // 6: nicklaw5.cauldron.v1alpha.PlayerService.CreatePlayer:input_type -> nicklaw5.cauldron.v1alpha.CreatePlayerRequest
	1, // 7: nicklaw5.cauldron.v1alpha.PlayerService.CreatePlayer:output_type -> nicklaw5.cauldron.v1alpha.CreatePlayerResponse
